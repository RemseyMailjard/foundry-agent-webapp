...
/**
 * The signed-in M365 Buddy chat experience, mounted at /app. Forces an Entra ID sign-in via
 * MSAL redirect — unlike the public marketing pages in `pages/marketing/`, nothing here is
